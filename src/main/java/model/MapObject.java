...
public abstract class MapObject implements Symbolizable, Viewable {
    ...
    public MapObject(int health, Civilization owner) {
        ...
        } else if (owner instanceof Skaikru) {
            color = Color.rgb(0, 255, 255, 0.4);
        } else if (owner instanceof StarkDynasty) {
            color = Color.rgb(50, 20, 220, 0.4);
        } else if (owner instanceof Mordor) {
            color = Color.rgb(255, 50, 50, 0.4);
        } else {
